                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="single-footer-widget mb-30">
                                ...
                                <form method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="footer-subscribe-form validate" novalidate>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="single-footer-widget mb-30 footer-menu">
                                ...
                                <ul>
                                    <li><a href="javascript:void(0)">Our Volunteer</a></li>
                                    <li><a href="javascript:void(0)">Donation</a></li>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="single-footer-widget mb-30 footer-menu">
                                ...
                                <p class="ft-address"><span>Address:</span>245 Central Tower, 4th Floow New City, California, USA</p>
